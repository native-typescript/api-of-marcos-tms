...
import {z} from "zod";
export const schemaOfBodyOf200ResponseToGetOfMethodsOfDynamicOfRoutesOfTransportOfStaticOfRoutesOfOdataOfStaticOfRoutesOfClient =
	z
		...
		.pipe(
			z
				...
				.transform<Transport>(function parseTransport(transport): Transport {
					const parsedTransport: Transport = {
						...
						carrierAcceptationUserId: transport.CarrierAcceptationUserId,
						...
						numericalTransportNumber: transport.NumericalTransportNumber,
